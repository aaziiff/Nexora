          ...
          >
            <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl bg-ivory-300 border border-stone/40">
              <img
                ...
                alt="Tactile hand coffee mill detail"
              ...
              <div className="absolute bottom-6 left-6 right-6 p-5 rounded-xl bg-ivory-100/90 backdrop-blur-md border border-stone/30">
                ...
                <h4 className="font-serif text-xl font-normal text-charcoal-950 mt-0.5">
                  Tactile Hand Coffee Mill
                </h4>
                <p className="text-xs text-charcoal-600 mt-1 font-sans">
                  Dual-bearing 420 stainless conical burrs milled for calm morning extractions.
                </p>
                <div className="pt-3 mt-3 border-t border-stone/20 flex items-center justify-between">
                  <span className="text-xs font-semibold text-charcoal-900">₹2,299</span>
                  <Link
                    to="/product/ergonomic-ceramic-burr-coffee-grinder"
